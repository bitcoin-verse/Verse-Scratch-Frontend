<script>
import { getAccount, waitForTransactionReceipt, switchNetwork, readContract, writeContract, disconnect, watchAccount } from '@wagmi/core'
...
export default {
    ...
    setup() {
        ...
        async function multiBuy(_giftAddress) {
            ...
            let receiver = getAccount(wagmiConfig).address
            if (_giftAddress) {
        ...
        async function getAllowance() {
            try {
                ...
                const data = await readContract(wagmiConfig, {
                    ...
                    chainId: 137,
                    args: [getAccount(wagmiConfig).address, activeProduct.value.contractAddress]
                })
                modalLoading.value = false;
        ...
        watchAccount(wagmiConfig, {
            onChange: (account) => {
                ...
                if (!currentAccountAddress.value) {
                    ...
                    if (currentAccountAddress.value != getAccount(wagmiConfig).address) {
                        location.reload()
                    }
                }
    ...
    >
        ...
        >
            <div>
                ...
                <div class="modal-body">
                    ...
                    <p class="subtext">Verse Scratch uses the Polygon network. Please change the network in your
                        connected wallet or click the button below to switch automatically.</p>
                    <a
                        class=""
                        target="_blank"
        ...
        >
            <div>
                ...
                <div class="modal-body">
                    ...
                    <p class="subtext short">Connect your wallet below to get started. We support all major wallet
                        providers.</p>
                    <a
                        class=""
                        target="_blank"
                    ...
                    <p class="modal-footer">Haven't set up a wallet yet? Get your wallet up and running with just a few
                        clicks at <a
                            target="_blank"
                            href="https://wallet.bitcoin.com/"
                        >wallet.bitcoin.com </a></p>
                </div>
            </div>
        </div>
        ...
        >
            <div>
                ...
                <div class="modal-body">
                    ...
                    <p class="subtext short">You need at least <span>{{ activeProduct.ticketPrice }} VERSE</span> on
                        Polygon in order to purchase a ticket</p>
                    ...
                    <p class="modal-footer">Already bought VERSE? Click <a @click="getBalance()">here</a> to refresh
                        your balance</p>
                </div>
            </div>
        </div>
        ...
        >
            ...
            parseInt(validatedAmount) }} VERSE</span>. This is used to pay for your ticket. </p>
                ...
                <p class="modal-footer">The Polygon network requires that you manually approve the spending of each
                    token in your wallet. <a
                        target="blank"
        ...
        >
            ...
            <div class="modal-body">
                ...
                <div
                    ...
                    v-if="giftTicket"
                >
                    <p>Please provide us with the Polygon wallet address of the person you want to gift the ticket to.
                    </p>
                    <input
                ...
                <!-- not enough balance -->
                <div v-if="verseBalance < validatedAmount * activeProduct.ticketPrice">
                    <p class="warning-balance">You do not have the amount required ({{ validatedAmount *
            activeProduct.ticketPrice }} VERSE) to complete this order. </p>
        ...
        >
            ...
            <div class="modal-body">
                ...
                <p class="subtext">You have at least <span>{{ activeProduct.ticketPrice * validatedAmount }}
                        VERSE</span>
                    in your wallet, and you've approved spending it. All that's left to do is buy your ticket.</p>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td
                            class="value"
                            v-if="!ticketInputAddress"
                        >{{ getAccount(wagmiConfig).address.slice(0, 7) }}..</td>
                    </tr>
                </table>
            ...
            <div class="modal-body">
                <div>
                    ...
                    <div v-if="giftTicket">
                        ...
                        <p class="subtext">The ticket has been sent to the your specified wallet! Share the following
                            link to let them know:</p>
                    ...
                    <div v-if="!giftTicket">
                        ...
                        <a
                            class=""
                            href="/tickets"
                        ><button class="btn verse-wide">View Your Ticket<span
                                    v-if="validatedAmount > 1">s</span></button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page">
        ...
        <div class="float-holder clearfix">
            ...
            activeProduct.highestPrice).toFixed(2) }}</p>
                ...
                <p class="terms-link">*Self custodial and verifiably random, powered by smart contracts and Chainlink
                    VRF. <a
                        target="_blank"
