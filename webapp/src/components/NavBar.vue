...
export default {
    setup() {
        ...
        return { config: core.config, account, isWallet, handleHome, ensUserName, openWalletModal, accountActive, truncateEthAddress, getAccount, connectedProvider} 
    }
...
<template>
    ...
    <div class="navbar">
        ...
        <div class="wallet">
            ...
            <div v-if="!ensUserName">
                <button class="btn verse-nav connected" v-if="accountActive && !isWallet" @click="openWalletModal(false)">{{truncateEthAddress(getAccount(config).address || "")}} <div :class="'provider-logo ' + connectedProvider"></div></button>
                 <button class="btn verse-nav connected" v-if="accountActive && isWallet" @click="openWalletModal(false)">{{truncateEthAddress(getAccount(config).address || "")}} <div :class="'provider-logo bitcoin'"></div></button>
            </div>
        </div>
    </div>
</template>
